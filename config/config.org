...
- C-x x s switches to a project’s perspective based on its name
  ...
  [[https://www.reddit.com/r/emacs/comments/d66s8r/how_to_get_the_most_from_perspectiveel/][adding predefined "layout"]] (+ source of code below)

#+BEGIN_SRC emacs-lisp
  (use-package perspective
    :demand t
    :init
    (setq presp-keymap-prefix (kbd ", c"))
    (customize-set-variable 'wg-prefix-key (kbd ", c"))
...
** Workgroups | [[https://github.com/pashinin/workgroups2][workgroups2]]
#+BEGIN_SRC emacs-lisp
  ...
  (use-package workgroups2
    ...
    (evil-leader/set-key
      "cr" 'wg-reload-session
      "cp" 'wg-switch-to-previous-workgroup)
